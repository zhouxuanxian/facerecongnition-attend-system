...
public class ExcelUtil {
	 /**
	     ...
	     * @param result    // 表数据
	     */
	    public static void createTable(HSSFWorkbook wb,HSSFSheet sheet,List<Map<String, Object>> result){
	        ...
	        for(int i = 0; i < result.size(); i++ ){
	            ...
	            for (String key : (result.get(i).keySet())) {
	                ...
	                cell.setCellStyle(cellStyle);
	              /*  String value = result.get(i).get(key).toString();
	                cell.setCellValue(value);*/
	                
	          cell.setCellValue(new HSSFRichTextString(result.get(i).get(key).toString()));
